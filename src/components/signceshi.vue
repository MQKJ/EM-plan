            ...
            <div class="se-photo-img" >
              <div class="show-bx">  
                ...
                <div class="picture" id="headerBX">
                  <img id="header" :src='headerImage' alt="" class="">
                </div> 
              </div>
            </div>
            <div class="se-mask">
...
export default {
  ...
  methods: {
    ...
    getFace () {
      this.headerImage = sessionStorage['faceImage']; // 缓存人脸图像
    ...
    cropp () {
        ...
        if (headerimg.length >= 1379738 * 19) this.yaSuoImg(0.01, roundedCanvas);
        if (headerimg.length >= 1379738 * 18 && headerimg.length < 1379738 * 19) this.yaSuoImg(0.016, roundedCanvas);
        if (headerimg.length >= 1379738 * 17 && headerimg.length < 1379738 * 18) this.yaSuoImg(0.019, roundedCanvas);
        if (headerimg.length >= 1379738 * 16 && headerimg.length < 1379738 * 17) this.yaSuoImg(0.02, roundedCanvas);
        if (headerimg.length >= 1379738 * 15 && headerimg.length < 1379738 * 16) this.yaSuoImg(0.021, roundedCanvas);
        if (headerimg.length >= 1379738 * 14 && headerimg.length < 1379738 * 15) this.yaSuoImg(0.025, roundedCanvas);
        if (headerimg.length >= 1379738 * 13 && headerimg.length < 1379738 * 14) this.yaSuoImg(0.034, roundedCanvas);
        if (headerimg.length >= 1379738 * 12 && headerimg.length < 1379738 * 13) this.yaSuoImg(0.038, roundedCanvas);
        if (headerimg.length >= 1379738 * 11 && headerimg.length < 1379738 * 12) this.yaSuoImg(0.042, roundedCanvas);
        if (headerimg.length >= 1379738 * 10 && headerimg.length < 1379738 * 11) this.yaSuoImg(0.045, roundedCanvas);
        if (headerimg.length >= 1379738 * 9 && headerimg.length < 1379738 * 10) this.yaSuoImg(0.05, roundedCanvas);
        if (headerimg.length >= 1379738 * 8 && headerimg.length < 1379738 * 9) this.yaSuoImg(0.06, roundedCanvas);
        if (headerimg.length >= 1379738 * 7.5 && headerimg.length < 1379738 * 8) this.yaSuoImg(0.6, roundedCanvas);
        if (headerimg.length >= 1379738 * 7 && headerimg.length < 1379738 * 7.5) this.yaSuoImg(0.7, roundedCanvas);
        if (headerimg.length >= 1379738 * 6.5 && headerimg.length < 1379738 * 7) this.yaSuoImg(0.8, roundedCanvas);
        if (headerimg.length >= 1379738 * 6 && headerimg.length < 1379738 * 6.5) this.yaSuoImg(0.95, roundedCanvas);
        if (headerimg.length >= 1379738 * 5.5 && headerimg.length < 1379738 * 6) this.yaSuoImg(0.97, roundedCanvas);
        if (headerimg.length >= 1379738 * 5 && headerimg.length < 1379738 * 5.5) this.yaSuoImg(0.10, roundedCanvas);
        if (headerimg.length >= 1379738 * 4.5 && headerimg.length < 1379738 * 5) this.yaSuoImg(0.11, roundedCanvas);
        if (headerimg.length >= 1379738 * 4 && headerimg.length < 1379738 * 4.5) this.yaSuoImg(0.12, roundedCanvas);
        if (headerimg.length >= 1379738 * 3.5 && headerimg.length < 1379738 * 4) this.yaSuoImg(0.13, roundedCanvas);
        if (headerimg.length >= 1379738 * 3 && headerimg.length < 1379738 * 3.5) this.yaSuoImg(0.14, roundedCanvas);
        if (headerimg.length >= 1379738 * 2.5 && headerimg.length < 1379738 * 3) this.yaSuoImg(0.15, roundedCanvas);
        if (headerimg.length >= 1379738 * 2 && headerimg.length < 1379738 * 2.5) this.yaSuoImg(0.16, roundedCanvas);
        if (headerimg.length >= 1379738 * 1 && headerimg.length < 1379738 * 2) this.yaSuoImg(0.17, roundedCanvas);
        if (headerimg.length >= 269481 * 1 && headerimg.length < 1379738 * 1) this.yaSuoImg(0.18, roundedCanvas);
        if (headerimg.length < 269481) this.yaSuoImg(1, roundedCanvas);
        this.postImg();
        this.panel = false;
    },
    yaSuoImg (e, w) {
