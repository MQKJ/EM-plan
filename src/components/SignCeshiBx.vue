<template> 
  <div class="contentBx"> 
      ...
      <div class="sign-bx">
        ...
        <div class="sign-imgbx">
          <div class="img-bg">
            <div class="sn-img">
              <div id="images">
                  <img  :src="signurl"  style="height: 8vh;width: 20vw;margin-top: 1vh;"> 
              </div>
            </div>
          </div>
          <div class="sign-time">
           ...
           <div class="left time-reset">
             <div class="reset-bx">
               <div class="reset-sign">
                   <p class="btn-reset btn-back " id="#clear">重签</p>
                 </div>
             </div>
           </div>
           <div class="clear"></div>
        ...
        <div class="scence-photo">
          ...
          <div class="se-pto-bx">
            ...
            <div class="se-photo-img" >
              <div class="show-bx">  
                <div class="picture" :style="'backgroundImage:url('+hImages+')'">  
                </div>  
              </div>
            </div>
            <div class="se-mask">
              <input v-if="yesupload" type="file" id="change"capture="camera" accept="image/*" @change="change">
              <div v-else class="loading-bx">
                <vue-loading  type="spiningDubbles"  :size="{ width: '50px', height: '50px'}"></vue-loading> 
                <h1 class="">上传中···</h1>
              </div>
            </div>
          </div>
      ...
      <div class="sign-btn">
        <router-link to='' class='a'><p class="btn-keep" @click='Submit()'>提交</p></router-link>
      </div>
    <!-- 上传遮罩层 -->  
...
export default {
  ...
  methods: {
    ...
    cropp () {
        ...
        this.zip(roundedCanvas);
        // if (headerimg.length >= 269481) {
        //   var img = new Image();
        //   img.onload = function () {
        //     var canvas;
        //     var ctx;
        ...
        //     img64 = canvas.toDataURL('image/jpeg', 0.9);
        //     console.log(img64);
        //     console.log(img64.length);
        //     this.headerImage = img64;
        //   };
        //   this.hImages = roundedCanvas.toDataURL('image/jpeg', 0.75);
        //   img.src = headerimg;
        // };
        // if (headerimg.length < 269481) {
        //   this.headerImage = roundedCanvas.toDataURL('image/jpeg', 0.75);
    ...
    postImg () {
      ...
      var param = {
          ...
          faceImage: this.headerImage, // 图片文件内容，base64编码的字符串，图片大小200k以内
    ...
    abnormal () { // 异常情况描述
        ...
        var errorCode = this.List.error_code;
        // var errorCode = 10304;
    ...
    Submit () {
      ...
      // if (this.List.result === false) {
      //   this.toast('图片采集失败!');
      //   return;
      // };
      // if (this.signurl !== '' && this.timer !== '' && this.headerImage !== '' && this.List.result === true) {
      //   sessionStorage['faceImage'] = this.headerImage; // 缓存脸部识别照片用于测试
